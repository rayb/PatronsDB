...
describe RafflesController do
  ...
  # RafflesController. Be sure to keep this updated too.
  def valid_session
    {}
  end
  ...
  describe "GET index" do
    it "assigns all raffles as @raffles" do
      ...
      assigns(:raffles).should eq([raffle])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested raffle as @raffle" do
      ...
      assigns(:raffle).should eq(raffle)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new raffle as @raffle" do
      ...
      assigns(:raffle).should be_a_new(Raffle)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created raffle as @raffle" do
        post :create, {:raffle => valid_attributes}, valid_session
        assigns(:raffle).should be_a(Raffle)
        assigns(:raffle).should be_persisted
      end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved raffle as @raffle" do
        ...
        Raffle.any_instance.stub(:save).and_return(false)
        post :create, {:raffle => {}}, valid_session
        assigns(:raffle).should be_a_new(Raffle)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested raffle" do
        raffle = Raffle.create! valid_attributes
        # Assuming there are no other raffles in the database, this
        # specifies that the Raffle created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Raffle.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => raffle.to_param, :raffle => {'these' => 'params'}}, valid_session
      end
      ...
      it "redirects to the raffle" do
        raffle = Raffle.create! valid_attributes
        put :update, {:id => raffle.to_param, :raffle => valid_attributes}, valid_session
        response.should redirect_to(raffle)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the raffle as @raffle" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Raffle.any_instance.stub(:save).and_return(false)
        put :update, {:id => raffle.to_param, :raffle => {}}, valid_session
        assigns(:raffle).should eq(raffle)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the raffles list" do
      raffle = Raffle.create! valid_attributes
      delete :destroy, {:id => raffle.to_param}, valid_session
      response.should redirect_to(raffles_url)
    end
  end
